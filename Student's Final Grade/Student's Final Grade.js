...
function finalGrade(examGrade, projecrsNumber) {
  if (examGrade > 90 || projecrsNumber > 10) {
    return 100;
  } else if (examGrade > 75 && projecrsNumber >= 5) {
    return 90;
  } else if (examGrade > 50 && projecrsNumber >= 2) {
    return 75;
  } else {
    return 0;
  }
